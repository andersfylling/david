...
int Listener::addListener(const uint8_t event, const std::function<void(std::map<std::string, std::string>)> func) {
...
void Listener::fireEvent(const uint8_t event, const std::map<std::string, std::string> arguments) {
